// SOURCE: cw-plus/contracts/cw3-fixed-multisig/src/contract.rs
// LICENSE: Apache-2.0 (CosmWasm/cw-plus)
// PURPOSE: Test fixture for detector validation — not compiled
